...
const AdvocateMyExpensePageThisMonthComp = () => {
  ...
  let newExpenseData = [];
  advocateThisMonthExpense.map((item, idx) => {
    newExpenseData.push({
      sl: idx + 1,
...
export default AdvocateMyExpensePageThisMonthComp;
