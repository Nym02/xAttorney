...
const AdvocateSettingsPagePrivacyPolicy = () => {
  return (
    <>
      <Paper className='w-full rounded-md overflow-y-scroll' elevation={4}>
        <div className='w-full bg-white rounded-md h-104 text-primarydark'>
          ...
          <Divider />
          {/* privacy policy contentents */}
          <div className='relative bg-white h-auto flex justify-center'>
            <div className='-mt-34 w-full pb-16'>
              {/* -------------main content--------------- */}
              <div className='px-6 mt-40'>
                <div className='flex flex-col space-y-6 mb-10 text-primarylight'>
                  <h1 className='text-3xl text-primarydark font-semibold'>
                    Privacy Policy
                  </h1>
                  ...
                  <div className='flex flex-col space-y-6'>
                    <h2 className='text-2xl text-primarylight font-semibold'>
                      Interpretation
                    </h2>
                    <p className='text-base'>
                    ...
                    <div className='pl-4'>
                      <ul className='list-disc list-outside'>
                        ...
                        <li>
                          ...
                          "Us" or "Our" in this Agreement) refers to Project X
                          Ltd., 02, House-22 Road No 04, Dhaka 1229.
                        </li>
                        <li>
                        ...
                        <li>Service refers to the Website or software.</li>
                        <li>
                          ...
                          <li>
                            ...
                            the Service infrastructure itself (for example, the
                            duration of a page visit).
                          </li>
                          <li>
                            Website refers to xattorney, accessible from{' '}
                            <span className='text-primarydark no-underline hover:underline'>
                              <Link to='/'>https://xattorney.app/</Link>
                            </span>
                          </li>
                          <li>
                  ...
                  <div className='flex flex-col space-y-6'>
                    ...
                    <div className='flex flex-col space-y-6'>
                      {/* personal data */}
                      <div className='flex flex-col space-y-6'>
                        <h1 className='font-medium text-xl'>Personal Data</h1>
                        <p className='text-base'>
                      ...
                      {/* Usage data */}
                      <div className='flex flex-col space-y-6'>
                        <h1 className='font-medium text-xl'>Usage Data</h1>
                        <p className='text-base'>
                      ...
                      <div className='flex flex-col space-y-6'>
                        ...
                        <div className='pl-4'>
                          <ul className='list-disc list-outside'>
                            <li>
                              ...
                              browser to refuse all Cookies or to indicate when
                              a Cookie is being sent. However, if You do not
                        ...
                        <p className='text-base'>
                          ...
                          mobile device when You go offline, while Session
                          Cookies are deleted as soon as You close Your web
                          browser. You can learn more about cookies here: All
                        ...
                        <div className='pl-4'>
                          <ul className='list-disc list-outside'>
                            <li>
                              ...
                              services available through the Website and to
                              enable You to use some of its features. They help
                              to authenticate users and prevent fraudulent use
                              of user accounts. Without these Cookies, the
                              services that You have asked for cannot be
                              provided, and We only use these Cookies to provide
                            ...
                            <li>
                              ...
                              your login details or language preference. The
                              purpose of these Cookies is to provide You with a
                              more personal experience and to avoid You having
                              to re-enter your preferences every time You use
                              the Website.
                            </li>
                          </ul>
                        </div>
                    ...
                    <div className='flex flex-col space-y-6'>
                      ...
                      {/* Law enforcement */}
                      <div className='flex flex-col space-y-6'>
                        <h1 className='font-medium text-xl'>Law enforcement</h1>
                        <p className='text-base'>
                    ...
                    <div className='pl-4'>
                      <ul className='list-disc list-outside'>
                        <li>
                          ...
                          <span className='text-primarydark no-underline hover:underline'>
                            <Link to='.contact-us'>
                              https://xattorney.app/contact-us
                            </Link>
                          </span>
                        </li>
                      </ul>
...
export default AdvocateSettingsPagePrivacyPolicy;
