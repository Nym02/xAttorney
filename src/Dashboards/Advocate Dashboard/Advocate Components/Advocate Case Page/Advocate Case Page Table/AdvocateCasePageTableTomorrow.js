...
const AdvocateCasePageTableTomorrow = () => {
  ...
  const firstDayOfCurrentMonth = tomorrow;
  ...
  const firstDay = convertDateToString(firstDayOfCurrentMonth);
  // const lastDay = convertDateToString(lastDayOfCurrentMonth);

  const getCaseListForThisMonth = firstDay => {
  ...
  //  useEffect(() => {
  //    getCaseListForThisMonth(firstDay);
  //  }, [firstDay]);
  ...
  const getCourtByCourtId = courtId => {
                ...
                <>
                  ...
                  <div className='flex lg:flex-row flex-col justify-between items-start lg:space-x-8 space-x-0 lg:space-y-0 space-y-8 w-full'>
                    ...
                    >
                      ...
                      >
                        ...
                        {courtDetailsInformationByCourtId?.caseTypeList?.map(
                          caseType => (
                  ...
                  <div className='flex lg:flex-row flex-col justify-between items-start lg:space-x-8 space-x-0 lg:space-y-0 space-y-8 w-full'>
                    ...
                    >
                      ...
                      >
                        {courtDetailsInformationByCourtId?.courtNameList?.map(
                          courtName => (
...
export default AdvocateCasePageTableTomorrow;
