...
const AdvocateCasePageTableYesterday = () => {
    ...
    if (caseInfo) {
      ...
      caseUpdate?.map((rank, i) => {
        if (caseUpdateLength === i + 1) {
          data = {
            courtName: viewCaseDetailsByID?.courtName?.name,
  ...
  }, [caseInfo, caseInfo?.caseUpdates, viewCaseDetailsByID]);
...
export default AdvocateCasePageTableYesterday;
