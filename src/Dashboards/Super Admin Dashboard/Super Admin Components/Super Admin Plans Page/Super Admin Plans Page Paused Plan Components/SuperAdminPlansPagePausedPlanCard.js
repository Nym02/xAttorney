...
import pauseNow from '../../../../../assets/images/active-now.svg';

const SuperAdminPlansPagePausedPlanCard = ({
  packageType,
  discountPrice,
  planMode,
  mainPrice,
        ...
        <div className='w-full h-full bg-white rounded-md text-primarydark px-11 py-6'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='flex flex-col space-y-3 items-end'>
              <h1 className='text-2xl'>
                Discounted Price:{' '}
                {discountPrice === null ? (
                  <span className='font-semibold'>0 TK</span>
                ) : (
          ...
          <div className='mt-9 flex justify-between items-center'>
            ...
            <div className='flex items-center space-x-2'>
              <span>Status:</span>
              <div className='flex items-center justify-center space-x-1 text-white bg-secondarydark h-9 w-36 rounded-full'>
                <Icon icon={pauseIcon} />
                <span>Paused</span>
              </div>
            </div>
...
export default SuperAdminPlansPagePausedPlanCard;
